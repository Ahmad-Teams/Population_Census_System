            ...
            <div class="sign-bar">
                <div class="container">
                    <ul>
                        ...
                        <li class="sign-up fl-left" ><a href="My_Profile.php" target="_parent"><strong id="logout"><? php if(isset($_SESSION['username'])){echo 'Hi_' . $_SESSION['username'];}else {echo 'Hi_UserName';}?> </strong></a></li>
                    </ul>
