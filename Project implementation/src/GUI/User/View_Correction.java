...
// side btn section
      ...
      Button View_my_family = new Button("View My Family\n" +"Members");
        ...
        View_my_family.setMinSize(170, 150);
        ...
        Make_request.setMinSize(170, 150);
        ...
        view_request.setMinSize(170, 150);
        ...
        View_Correction.setMinSize(170, 150);
...
//second section
        ...
        Scene scene = new Scene(all,900,750);           
